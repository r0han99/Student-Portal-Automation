...
if(CONNECTION_CHECK()):
    ...
    while True:
        ...
        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗚-𝗟𝗲𝗮𝗿𝗻 𝗠𝗮𝘁𝗲𝗿𝗶𝗮𝗹𝘀{:>51}'.format(
            Fore.RED + '𝗠𝗮𝘁𝗲𝗿𝗶𝗮𝗹 || 𝗠'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗔𝗰𝗮𝗱𝗲𝗺𝗶𝗰 𝗦𝘁𝗮𝘁𝘂𝘀{:>52}'.format(
            Fore.RED + '𝗦𝘁𝗮𝘁𝘂𝘀 || 𝗦'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗔𝘁𝘁𝗲𝗻𝗱𝗮𝗻𝗰𝗲 𝗣𝗿𝗲𝗱𝗶𝗰𝘁𝗼𝗿{:>51}'.format(
            Fore.RED + '𝗣𝗿𝗲𝗱𝗶𝗰𝘁𝗼𝗿 || 𝗣'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗔𝘁𝘁𝗲𝗻𝗱𝗮𝗻𝗰𝗲 𝗔𝘂𝘁𝗼𝗺𝗮𝘁𝗲{:>50}'.format(
            Fore.RED + '𝗔𝘂𝘁𝗼𝗺𝗮𝘁𝗲 || 𝗔'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗔𝗽𝗽𝗹𝘆 𝗳𝗼𝗿 𝗣𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻{:>50}'.format(
            Fore.RED + '𝗔𝗽𝗽𝗹𝘆 || 𝗮𝗽'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗣𝗲𝗿𝗺𝗶𝘀𝘀𝗶𝗼𝗻 𝗦𝘁𝗮𝘁𝘂𝘀{:>52}'.format(
            Fore.RED + '𝗽𝘀𝘁𝗮𝘁 || 𝗽𝘀'))

        print(Fore.RED + '[ * ]' + Fore.WHITE + ' 𝗘𝘅𝗶𝘁 𝗖𝗼𝗱𝗲{:>57}'.format(
            Fore.RED + '𝗲𝘅𝗲 || 𝗲'))
